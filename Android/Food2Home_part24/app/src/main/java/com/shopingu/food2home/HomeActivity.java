package com.shopingu.food2home;
...
import com.shopingu.food2home.EventBus.CategoryClick;
...
import com.shopingu.food2home.EventBus.PopularCategoryClick;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                R.id.nav_food_detail,R.id.nav_cart)
                                ...
                                FirebaseDatabase.getInstance()
                                        ...
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                {
                                                    Toast.makeText(HomeActivity.this, "Sorry Selected Item Not Available", Toast.LENGTH_SHORT).show();
                                                }
