package com.shopingu.food2home.ui.cart;
...
import com.shopingu.food2home.Adapter.MyCartAdapter;
import com.shopingu.food2home.Common.Common;
import com.shopingu.food2home.Common.MySwipeHelper;
...
import com.shopingu.food2home.EventBus.HideFABCart;
import com.shopingu.food2home.EventBus.UpdateItemInCart;
import com.shopingu.food2home.HomeActivity;
import com.shopingu.food2home.Model.Order;
...
public class CartFragment extends Fragment {
    ...
    void onPlaceOrderClick(){
        ...
        builder.setTitle("Please Select the Address!");
        ...
        rdi_other_address.setOnCheckedChangeListener((compoundButton, b) -> {
            ...
            {
                edt_address.setText("");
                edt_address.setText("Enter your address");
                txt_address.setVisibility(View.GONE);
            }
        });
                ...
                if (!gps_enabled ) {
                            ...
                            .setPositiveButton( "Settings" , new
                                    DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick (DialogInterface paramDialogInterface , int paramInt) {
                                            ...
                                            ProgressDialog dialog = ProgressDialog.show(getContext() ,"Searching for Location","Please wait..",true);
                                            final Handler handler = new Handler();
                                            handler.postDelayed(new Runnable() {
                                                @Override
                                                public void run() {
                                                    rdi_ship_to_this.setChecked(true);
                                                    dialog.dismiss();
                                                }
                                            },20000);
                    ...
                    fusedLocationProviderClient.getLastLocation()
                            ...
                            .addOnCompleteListener(task -> {
                                ...
                                Single<String> singleAddress = Single.just(getAdressFromLatLng(task.getResult().getLatitude(),
            ...
            cartDataSource.sumPriceInCart(Common.currentUser.getUid())
                    ...
                    .subscribe(new SingleObserver<Double>() {
                        ...
                        public void onSuccess(Double totalPrice) {
                            ...
                            order.setUserTd(Common.currentUser.getUid());
    ...
    private String getAdressFromLatLng(double latitude, double longitude) {
        ...
        try {
            ...
            if (addressList != null && addressList.size()>0)
            {
                ...
                result = "Issue getting your Address! Please Provide Address Manually";
        ...
        cartDataSource.sumPriceInCart(Common.currentUser.getUid())
                ...
                .subscribe(new SingleObserver<Double>() {
                    ...
                    public void onSuccess(Double aDouble) {
                        txt_total_price.setText(new StringBuilder("Total : ").append(aDouble).append(" ₹"));
                    }
        ...
        cartDataSource.sumPriceInCart(Common.currentUser.getUid())
                ...
                .subscribe(new SingleObserver<Double>() {
                    ...
                    public void onSuccess(Double price) {
                        ...
                        .append(Common.formatPrice(price)).append(" ₹"));
                    }
